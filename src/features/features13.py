...
SORTIES
-------
  DATA/processed/X_features_v13.parquet   — features (1 ligne/jour)
  DATA/processed/Y_target_v13.parquet     — cibles load 96 pas (1 ligne/jour)
  DATA/processed/B_baseline_v13.parquet   — prévisions Oiken 96 pas (pour benchmark)
"""
...
CSV     = BASE / "oiken-data.csv"                       # fichier brut Oiken
METEO   = BASE / "meteo_multistation_v5.parquet"        # parquet météo (InfluxDB exporté)
OUT     = BASE / "processed"
