...
Sorties :
  DATA/models7/lgbm_t{000..095}.pkl    — 96 modèles finaux
  DATA/models7/metrics.parquet          — RMSE / MAE par pas + global vs baseline
  DATA/models7/predictions_test.parquet — prédictions sur le jeu de test
  DATA/models7/optuna_results.parquet   — historique des trials Optuna
  DATA/models7/best_params.json         — meilleurs hyperparamètres
"""
...
X_PATH = BASE / "processed" / "X_features_v7.parquet"
Y_PATH = BASE / "processed" / "Y_target_v7.parquet"
B_PATH = BASE / "processed" / "B_baseline_v7.parquet"
OUT    = BASE / "models7"
